...
public:
    BoundsCheckInsn(Instruction *insn, int64_t idxToCheck, int64_t maxArrIdx)
        : Instruction(Opcode::BOUNDSCHECK, DataType::REF),
...
private:
    ...
    int64_t idxToCheck_ {0};
    int64_t maxArrIdx_ {0};
};
